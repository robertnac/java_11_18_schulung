...
public class TrainingWebController {
    ...
    public TrainingWebController(TrainingService trainingService, TrainingFilterService trainingFilterService, TrainingSearchService trainingSearchService, TrainingConfig trainingConfig) {
    ...
    public ModelAndView trainings(@RequestParam(value = "filter", required = false) String filter) {
        ...
        mav.addObject("heading", trainingConfig.getStartPageHeading());
