...
public class TrainingApiController {
    ...
    public List<TrainingEntity> getCatalog(@PathVariable String query) {
        return trainingJpaRepository.findByTopicContainingIgnoreCase(query, TrainingEntity.class);
    }
